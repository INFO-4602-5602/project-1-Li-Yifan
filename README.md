...
I'm working with YanPeng, Zhixing Change, Zening Li. We finished part 1 to part 5. And some extra credit. When we click the bar chart, we the color will change. When you click the point, the coordinate will show up. Tooltips part also been down. and Background changes. I add .background in css and html file to change file.
